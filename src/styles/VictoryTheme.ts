...
// * Colors
// *
const linearRed = new LinearGradient({
  colors: ['#FF6859', '#CC5347'],
  start: {x: 0, y: 0},
  end: {x: 0, y: 1},
});
const linearRedLight = new LinearGradient({
  colors: ['#FFB9B9', '#CC5347'],
  start: {x: 0, y: 0},
  end: {x: 0, y: 1},
});

const colors = [linearRed, linearRedLight];
...
// * Typography
// *
const sansSerif = "'Poppins-Medium'";
